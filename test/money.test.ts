// money.test.ts — the hot module's tests. ESM + Vitest
...
describe('fromDecimal rounds to the currency precision', () => {
  it('fromDecimal rounds to the currency precision', () => {
...
describe('sum totals a list in one currency', () => {
  it('sum totals a list in one currency', () => {
...
describe('allocate splits exactly with no lost cents', () => {
  it('allocate splits exactly with no lost cents', () => {
...
describe('allocate respects integer weights', () => {
  it('allocate respects integer weights', () => {
...
describe('allocate rejects all-zero weights', () => {
  it('allocate rejects all-zero weights', () => {
