// test/money.test.js — the hot module's tests. ESM + Vitest
...
describe('add and subtract require the same currency', () => {
  ...
  it('throws error on different currencies', () => {
...
describe('allocate respects integer weights', () => {
  it('splits correctly for weighted distribution', () => {
...
describe('allocate rejects all-zero weights', () => {
  it('throws error for all-zero weights', () => {
