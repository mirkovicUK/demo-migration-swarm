...
describe("equal split sums to the total and distributes the remainder", () => {
...
describe("shares split uses integer weights and sums to total", () => {
...
describe("percentage split sums to total even with rounding drift", () => {
...
describe("exact split preserves the provided amounts", () => {
