...
// debts. Depends on money.ts, expense.js and split.js — the deepest node in the
...
function simplifyDebts(balances: Record<string, Money>): Transfer[] {
...
function validateSettlement(balances: Record<string, Money>, transfers: Transfer[]): SettlementValidation {
...
export { computeBalances, simplifyDebts, settlementSummary, balanceFor, debtMatrix, totalTransferred, validateSettlement };