...
import { isSplitKind, type Expense, type SplitRule } from "./expense.js";
...
function isMoney(x: unknown): x is Money {
  return (
    !!x && typeof x === "object" && "amountMinor" in x && typeof x.amountMinor === "number" && "currency" in x && typeof x.currency === "string"
  );
}
