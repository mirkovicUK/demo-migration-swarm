...
function computeBalances(expenses, currency) {
...
function settlementSummary(expenses, currency) {
...
function balanceFor(balances, memberId) {
...
function debtMatrix(expenses, currency) {
  const cur = resolveCurrency(expenses, currency);
  const matrix = {};

  function owe(debtor, creditor, amount) {
...
function validateSettlement(balances, transfers) {
  const residual = {};
...
function resolveCurrency(expenses, currency) {
