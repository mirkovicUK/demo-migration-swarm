...
import { fromDecimal, DEFAULT_CURRENCY, CURRENCY_MINOR_UNITS, type Money } from "./money.js";
...
export function toCount(value: unknown, fallback: number = 1): number {
